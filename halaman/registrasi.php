...
<head>
    ...
    <link rel="stylesheet" href="AdminLTE-3/dist/css/adminlte.min.css?v=3.2.0">
    <script nonce="fa89ea91-3106-4569-9567-73439960bc0b">
        (function(w, d) {
            ! function(a, b, c, d) {
                a[c] = a[c] || {};
                a[c].executed = [];
...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="card card-outline card-primary">
            <div class="register-logo">
                <a href="../../index2.html"><b>Halim</b>Nursery</a>
            </div>
            <div class="card">
    ...
    <script src="AdminLTE-3/dist/js/adminlte.min.js?v=3.2.0"></script>
</body>
